...
async function renderSettings() {
  ...
  document.getElementById("settings").innerHTML = `
    ...
    <div class="panel">
      ...
      <div class="grid">
        ...
        <label>智谱 Reader 回退<select id="glmReader"><option value="true">启用</option><option value="false">停用</option></select></label>
  ...
  document.getElementById("glmReader").value = String(rss.glm_reader_enabled ?? true);
}
  ...
  if (e.target.id === "saveSettingsBtn") {
    ...
    const body = {
      ...
      rss: {
        ...
        glm_reader_enabled: document.getElementById("glmReader").value === "true",
